...
public class UserUtils {
    ...
    public static String getUserName(HttpServletRequest request) {
        String username = "";
        String authorization = request.getHeader(AuthConstants.REQ_HEADER);
        if (StringUtils.isEmpty(authorization)) {
            return username;
        }
        String token = StringUtils.substringAfter(authorization, AuthConstants.TOKEN_SPLIT);
    ...
    public static String getToken(HttpServletRequest httpServletRequest) {
        String authorization = httpServletRequest.getHeader(AuthConstants.REQ_HEADER);
        return StringUtils.substringAfter(authorization, AuthConstants.TOKEN_SPLIT);
    }
